...
def test_package_filter_pyarrow() -> None:
    ...
    filter = mamba_press.filter.ByNamePackagesFilter(
        to_prune=to_prune,
...
def test_python_filter_pinocchio() -> None:
    ...
    filter = mamba_press.filter.PythonDependenciesPackagesFilter(
        requested_packages=requested_packages,
    )
    pruned = filter.filter_solution(solution)
...
def make_pyarrow_solution() -> mamba.solver.Solution:
    ...
    packages = [
        PackageInfo(name="python_abi", version="3.13", build_string="7_cp313", depends=[]),
        PackageInfo(name="libcxx", version="20.1.6", build_string="ha82da77_0", depends=["__osx >=11.0"]),
        PackageInfo(name="libzlib", version="1.3.1", build_string="h8359307_2", depends=["__osx >=11.0"]),
        PackageInfo(name="bzip2", version="1.0.8", build_string="h99b78c6_7", depends=["__osx >=11.0"]),
        PackageInfo(name="libexpat", version="2.7.0", build_string="h286801f_0", depends=["__osx >=11.0"]),
        PackageInfo(name="libffi", version="3.4.6", build_string="h1da3d7d_1", depends=["__osx >=11.0"]),
        PackageInfo(name="liblzma", version="5.8.1", build_string="h39f12f2_1", depends=["__osx >=11.0"]),
        PackageInfo(name="libmpdec", version="4.0.0", build_string="h5505292_0", depends=["__osx >=11.0"]),
        PackageInfo(name="ncurses", version="6.5", build_string="h5e97a16_3", depends=["__osx >=11.0"]),
        PackageInfo(name="tzdata", version="2025b", build_string="h78e105d_0", depends=[]),
        PackageInfo(
        ...
        PackageInfo(name="c-ares", version="1.34.5", build_string="h5505292_0", depends=["__osx >=11.0"]),
        PackageInfo(name="libev", version="4.33", build_string="h93a5062_2", depends=[]),
        PackageInfo(name="libiconv", version="1.18", build_string="hfe07756_1", depends=["__osx >=11.0"]),
        PackageInfo(
